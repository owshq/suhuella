 ...
 * Output: docs/generated/DOC-INVENTORY-001.md
 */
...
const OUT = join(ROOT, "docs/generated/DOC-INVENTORY-001.md");
...
function classify(path, content, status) {
  ...
  if (rel.startsWith("docs/generated/")) {
    return {
      classification: "Generated / audit artifact",
      action: "keep",
      ambiguous: false,
      notes: "Audit output. Not institutional.",
    };
  }
  ...
  if (rel === "docs/generated/DOC-INVENTORY-001.md" || rel === "DOC-INVENTORY-001.md") {
...
function findBrokenRefs(allMd) {
  ...
  const broken = [];
  const seen = new Set();
  const EXCLUDE_FROM_BROKEN_SCAN = new Set(["docs/generated/DOC-INVENTORY-001.md", "DOC-INVENTORY-001.md"]);
...
| **Generated / audit** | ${rows.filter((r) => r.classification === "Generated / audit artifact").length} |
