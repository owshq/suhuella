/** Official cloud source marks — inline SVG only, no external assets. */

import type { SourceIconId } from '../types'

const OFFICIAL_SOURCE_MARK_IDS = ['icloud', 'dropbox', 'onedrive', 'google_drive'] as const

export type OfficialSourceMarkId = (typeof OFFICIAL_SOURCE_MARK_IDS)[number]

export function isOfficialSourceMark(iconId: SourceIconId): iconId is OfficialSourceMarkId {
  return (OFFICIAL_SOURCE_MARK_IDS as readonly string[]).includes(iconId)
}
...
export function OfficialSourceMark({
  ...
  if (iconId === 'dropbox') {
    return (
      <svg viewBox="0 0 24 24" className={className} aria-hidden>
        <path
          fill="#0061FF"
          d="M6 1.807 0 5.629l6 3.822 6.001-3.822L6 1.807zm12 0-6 3.822 6 3.822 6-3.822-6-3.822zM0 13.274l6 3.822 6.001-3.822L6 9.452 0 13.274zM18 9.452l-6 3.822 6 3.822 6-3.822-6-3.822zM6 18.371l6.001 3.822 6-3.822-6-3.822L6 18.371z"
        />
      </svg>
    )
  }
  ...
  if (iconId === 'onedrive') {
    return (
      <svg viewBox="0 5.5 32 20.5" className={className} aria-hidden>
        <path
          fill="#0364b8"
