...
```text
project-release.mjs  →  release-version-check.mjs  →  build
```
...
- [RELEASE-LIFECYCLE-001.md](RELEASE-LIFECYCLE-001.md) Phase A
- [RELEASE-PUBLISH-PIPELINE-001.md](RELEASE-PUBLISH-PIPELINE-001.md)

**Next (implementation, not architecture):** [DESKTOP-RELEASE-HOSTING-001.md](DESKTOP-RELEASE-HOSTING-001.md)

**Release process (frozen):** [docs/governance/RELEASE-PROCESS-FROZEN.md](docs/governance/RELEASE-PROCESS-FROZEN.md)

**Next (product):** [PRE-BETA-SANITY-001.md](PRE-BETA-SANITY-001.md) → [PRIVATE-BETA-001.md](PRIVATE-BETA-001.md) → RC
